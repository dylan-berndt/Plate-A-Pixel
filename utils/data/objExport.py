...
def writeObj(triangles, path, scale=MM_PER_UNIT):
    ...
    file, scaling coordinates by `scale` (world units -> millimeters) on
    the way out. No vertex deduplication or normals - OBJ doesn't require
    either, and viewers/slicers derive normals from face winding anyway."""
    with open(path, "w") as f:
        f.write("# Generated by Plate-A-Pixel\n")
        f.write(f"# Units: millimeters ({scale} mm per world unit)\n")
        for v in triangles:
