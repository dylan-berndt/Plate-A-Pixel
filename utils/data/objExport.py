...
def writeObj(triangles, path, cellWidth=MM_PER_UNIT, cellHeight=MM_PER_UNIT):
    ...
    cellWidth scales X and Z (a pixel's footprint), cellHeight scales Y
    (one height-layer's thickness) - the two are independent since a
    ...
    with open(path, "w") as f:
        ...
        for v in triangles:
            f.write(f"v {v.x * cellWidth} {v.y * cellHeight} {v.z * cellWidth}\n")
